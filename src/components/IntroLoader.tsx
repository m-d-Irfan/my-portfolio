...
export default function IntroLoader() {
  ...
  useEffect(() => {
    ...
    // 2.8s smooth precision timer giving ample time for context and asset caching
  ...
  return (
    <div
      className={`fixed inset-0 w-screen h-screen z-[999999] overflow-hidden flex flex-col justify-between p-6 sm:p-16 bg-[#0a0e14] text-[#f8fafc] touch-none select-none transition-transform duration-700 ease-[cubic-bezier(0.76,0,0.24,1)] ${
    ...
    >
      ...
      <div className="my-auto text-center space-y-4 sm:space-y-6 w-full max-w-full px-2">
        ...
        <div className="w-44 sm:w-72 h-[2px] bg-white/10 mx-auto rounded-full overflow-hidden relative mt-2">
          <div
            className="h-full bg-gradient-to-r from-primary via-secondary to-accent transition-all duration-75 ease-out shadow-[0_0_12px_rgba(16,185,129,0.8)]"
      ...
      <div className="flex justify-between items-end text-xs font-mono">
        <span className="opacity-50 tracking-wider">PRELOADING CONTEXT DATA...</span>
